import { Edit, Hash, Image, PictureInPicture, Sparkles } from 'lucide-react'
...
const GenerateImages = () => {
  ...
  const imageStyle = ['Realistic style','Ghibli Style','Anime style','Cartoon style',
  ...
  return (
    ...
    text-slate-700'>
      ...
      border-gray-200'>
        ...
        rounded-md border border-gray-300' placeholder='A dog with brown fur...' required/>
